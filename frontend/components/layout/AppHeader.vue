  ...
  <header class="sticky top-0 z-40 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      ...
      <div class="flex items-center gap-2 sm:gap-6">
        ...
        <nav v-if="user" class="hidden sm:flex items-center gap-1">
          ...
          <NuxtLink
            to="/lab"
            class="px-3 py-1.5 text-sm font-medium rounded-md transition-colors"
            :class="route.path === '/lab' ? 'bg-accent text-accent-foreground' : 'text-muted-foreground hover:text-foreground hover:bg-accent/50'"
          >
            Lab
          </NuxtLink>
          <NuxtLink
    ...
    >
      ...
      <NuxtLink
        ...
        @click="mobileMenuOpen = false"
        class="block px-3 py-2 text-sm font-medium rounded-md transition-colors"
        :class="route.path === '/lab' ? 'bg-accent text-accent-foreground' : 'text-muted-foreground hover:bg-accent/50'"
      >
        Lab
      </NuxtLink>
      <NuxtLink
